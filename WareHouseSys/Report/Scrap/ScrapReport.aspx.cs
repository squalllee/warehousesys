...
namespace WareHouseSys.Report.Scrap
{
    public partial class ScrapReport : System.Web.UI.Page
    {
        ReportDocument repDoc = null;
        protected void Page_Load(object sender, EventArgs e)
        {
            string reportType = Request["Type"];

            string reportPath = "";
            reportPath = Server.MapPath("") + "\\Scrap.rpt";
