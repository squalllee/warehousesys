...
namespace WareHouseSys.Report.MaterialUpdate
{
    public partial class MaterialUpdateReport : System.Web.UI.Page
    {
        ReportDocument repDoc = null;
        protected void Page_Load(object sender, EventArgs e)
        {
            string reportPath = Server.MapPath("") + "\\MaterialUpdate.rpt";
