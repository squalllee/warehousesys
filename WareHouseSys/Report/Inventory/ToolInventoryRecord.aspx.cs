...
namespace WareHouseSys.Report.Inventory
{
    public partial class ToolInventoryRecord1 : System.Web.UI.Page
    {
        ReportDocument repDoc = null;
        protected void Page_Load(object sender, EventArgs e)
        {
            string reportPath = Server.MapPath("") + "\\ToolInventoryRecord.rpt";
